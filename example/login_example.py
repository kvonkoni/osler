...
incorrect_password = Diagnosis("User entered incorrect password", "The user entered an incorrect password", "Send the user a password reset email link.", {is_internet_connected_true, used_site_login_true, is_internet_connected_true, correct_email_true, incorrect_password_true}, 100)
