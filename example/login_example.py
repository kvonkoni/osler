...
email_in_spam_folder_true = email_in_spam_folder = Criterion(received_password_reset_email, True)
email_in_spam_folder_false = email_in_spam_folder = Criterion(received_password_reset_email, False)
...
incorrect_password = Diagnosis("User entered incorrect password", "The user entered an incorrect password", "Send the user a password reset email link.", {is_internet_connected_true, used_site_login_true, is_internet_connected_true, correct_email_true, incorrect_password_false}, 100)
...
email_blocked_by_firewall = Diagnosis("User email blocked by firewall", "The user's company firewall is blocking emails from Firmex", "Send the user's company's IT department the whitelisting instructions.", {is_internet_connected_true, email_in_spam_folder_true, received_password_reset_email_true, correct_email_true}, 10)

#Defining an issue

issue = Issue("Can't login: Invalid Credentials", "The user cannot login to their account. They are seeing an error that says invalid credentials.", {no_internet_connection, no_attempt_reported, incorrect_email, incorrect_password, email_filtered_as_spam})
