...
from osler.diagnosis import Diagnosis, compare_diagnoses
...
email_in_spam_folder = Assertion("Invitation or password reset email is in the user's spam/junk folder", "Is the invitation/password reset email in the user's email spam or junk folder?")
...
invalid_password = Diagnosis("User entered incorrect password", "The user entered an incorrect password", "Send the user a password reset email link.", {is_internet_connected_true, used_site_login_true, correct_email_true, incorrect_password_true}, 100)
email_filtered_as_spam = Diagnosis("User's invitation or password reset was filtered by their spam or junk folder", "The user's invitation or password reset was filtered by their spam or junk folder", "Put yourself as backup email, send new reset email, forward to user.", {is_internet_connected_true, email_in_spam_folder_true, received_password_reset_email_true, correct_email_true}, 10)
...
compare_diagnoses(incorrect_password, email_filtered_as_spam)
