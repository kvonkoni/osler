...
class TestDiagnosis(unittest.TestCase):
    ...
    def test_equality(self):
        ...
        diagnosis3 = Diagnosis('Diagnosis 1', {Criterion(assertionA, True), Criterion(assertionB, False), Criterion(assertionC, False), Criterion(assertionX, False)}, 0.25)
    ...
    def test_undiagnosable(self):
        ...
        assertionX = Assertion("assertion X")
        diagnosis1 = Diagnosis('Diagnosis 1', {Criterion(assertionA, True), Criterion(assertionB, False), Criterion(assertionC, True), Criterion(assertionX, False)}, 0.25)
        diagnosis2 = Diagnosis('Diagnosis 2', {Criterion(assertionA, True), Criterion(assertionB, False), Criterion(assertionC, True)}, 0.5)
        self.assertEqual(undiagnosable({diagnosis1, diagnosis2}), {diagnosis1, diagnosis2})
