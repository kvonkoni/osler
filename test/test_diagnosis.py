...
class TestDiagnosis(unittest.TestCase):
    ...
    def test_equality(self):
        ...
        criterionNB = Criterion(assertionB, False)
        criterionX = Criterion(assertionX, True)
        diagnosis1 = Diagnosis('Diagnosis 1', 'Diagnosis Description 1', 'Diagnosis Remedy 1', {criterionA, criterionNB, criterionC, criterionX}, 0.25)
        diagnosis2 = Diagnosis('Diagnosis 2', 'Diagnosis Description 2', 'Diagnosis Remedy 2', {criterionA, criterionNB, criterionC, criterionX}, 0.5)
        diagnosis3 = Diagnosis('Diagnosis 1', 'Diagnosis Description 1', 'Diagnosis Remedy 1', {criterionA, criterionNB, criterionNC, criterionX}, 0.25)
